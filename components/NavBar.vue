<template>
  <nav class="shadow-sm border-b bg-white w-full p-4">
    <div class="flex items-center justify-between">
      <!-- Header logo -->
      <div class="flex">
        <Tailwind />
        <!-- Desktop toggle -->
        <div class="hidden md:block mx-10 my-auto">
          <button @click="toggleSideBarDesktop">
            <svg
              class="h-8 w-8 fill-current text-blue-600 hover:text-blue-900"
              fill="none"
      ...
      <div class="hidden md:block">
        <ul class="flex space-x-8 text-sm font-sans">
          ...
          <li><a href="/about" class="border-b-2 border-blue-500 pb-1">Services</a></li>
      ...
      <aside class="p-5 transform top-0 left-0 w-64 bg-white fixed h-full overflow-auto ease-in-out transition-all duration-300 z-30" :class="isOpen ? 'translate-x-0' : '-translate-x-full'">
        ...
        <ul class="divide-y font-sans">
          ...
          <li><a href="#" class="my-4 inline-block" @click="isOpen = false">Services</a></li>
          <li><a href="#" class="my-4 inline-block" @click="isOpen = false">Features</a></li>
          ...
          <li><a href="#" class="my-8 w-full text-center font-semibold cta inline-block bg-blue-500 hover:bg-blue-600 px-3 py-2 rounded text-white" @click="isOpen = false">Sign Up</a></li>
        </ul>
...
export default {
  ...
  mounted () {
    document.addEventListener('keydown', (e) => {
      if (e.esc === 27 && this.isOpen) { this.isOpen = false }
    })
  },
  methods: {
    drawer () {
